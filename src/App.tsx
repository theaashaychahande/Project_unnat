      ...
      <div className="min-h-screen bg-gov-background flex items-center justify-center text-center">
        <div className="flex flex-col items-center gap-6">
          ...
          <div className="space-y-2">
            <h2 className="text-2xl font-baskerville font-bold text-gov-green-dark">
              Initializing UNNAT
            </h2>
            <p className="text-gov-text-secondary font-bold uppercase tracking-[0.2em] text-[10px] animate-pulse">

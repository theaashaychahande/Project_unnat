...
const translations = {
  ...
  hi: {
    ...
    hero: {
      ...
      description:
        "नागुपर के नागरिकों के लिए नागरिक मुद्दों को उठाने और वास्तविक समय में उनके समाधान को ट्रैक करने के लिए एक पारदर्शी मंच।",
  ...
  mr: {
    ...
    hero: {
      ...
      description:
        "नागपूरच्या नागरिकांसाठी नागरी समस्या मांडण्यासाठी आणि त्यांच्या निवारणाचा रिअल टाइममध्ये मागोवा घेण्यासाठी एक पारदर्शक व्यासपीठ.",
...
const StatItem = ({
  ...
  <div className="text-center p-4">
    ...
    <p className="font-baskerville text-4xl font-bold text-gov-green-dark mb-1">
      {value}
    </p>
      ...
      <nav className="bg-gov-white shadow-sm sticky top-0 z-50">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center space-x-3">
            ...
            <h1 className="font-baskerville text-2xl font-bold text-gov-green-dark">
              {t.nav.title}
            </h1>
          </div>
      ...
      <main>
        ...
        <section className="container mx-auto px-6 py-16 text-center">
          <div className="card-gov p-8 md:p-16 max-w-4xl mx-auto">
            <p className="text-gov-green-primary font-mono text-sm mb-4 tracking-wider">
              {t.hero.badge}
            </p>
            ...
            <p className="text-2xl text-gov-text-secondary mb-6">
              {t.hero.subtitle}
            </p>
            ...
            <p className="text-gov-text-secondary text-sm font-mono">
              {t.hero.languages}
            </p>
          </div>
        </section>
        ...
        <section className="container mx-auto px-6 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card-gov p-8 relative overflow-hidden hover:-translate-y-1 transition-transform">
              <span className="absolute -top-4 -left-4 text-8xl font-bold text-gov-border opacity-50">
                01
              </span>
              <h4 className="text-xl font-bold text-gov-green-dark mb-4">
      ...
      <footer className="bg-gov-green-dark text-white py-12">
        <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex items-center space-x-3">
            <span className="text-3xl">🇮🇳</span>
            <div>
              <h4 className="font-baskerville text-xl font-bold">
                {t.nav.title}
              </h4>
          ...
          <div className="text-right">
            ...
            <div className="w-24 h-12 bg-white/10 ml-auto flex items-center justify-center text-white/50 text-xs rounded font-bold border border-white/20">
              GOI Logo
            </div>
          </div>
        </div>
